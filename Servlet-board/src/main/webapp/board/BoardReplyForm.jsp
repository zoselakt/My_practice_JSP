...
<body>
<h2>답글작성</h2>
<form method="post" action="BoardReplyAction.do?page=${page }"name="boardForm">
	...
	<table width="700" border="3" align="center">
		...
		<tr>
			<td id="title">작성자</td>
			<td><input name="vo_subject" type="text" size="70" maxlength="100" value=""/></td>
		</tr>
		<tr>
			<td id="title">내용</td>
			<td><textarea name="vo_content" rows="20" cols="72"></textarea></td>
		</tr>
