	...
	<div id="wrap">
		...
		<div id="board">
			<table id="detailBoard" width="800" border="3">
				...
				<tr>
					<td id="title">내용</td>
					<td>${fn:replace(vo.board_content, cn, br}</td>
				</tr>
				<tr>
					<td id="title">첨부파일</td>
					...
					<tr>
						...
						<td width="550">
							<div class="text_wrapper">
								${fn:replace(vo.comment_content, cn, br)}
							</div>
						</td>
						<td>
...
function cmUpdateOpen(comment_num) {
	window.name="parentForm";
	windiw.open("CommentUpdateFormAction.co?num="+comment_num, "updateForm","width=570, height=350, resizable = no scrollbars = no");
}
</script>
